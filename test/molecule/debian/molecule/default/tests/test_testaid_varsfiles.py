...
def test_testaid_varsfiles_role_defaults(host, testvars):
...
def test_testaid_varsfiles_project_vars(host, testvars):
    assert testvars['my_project_var'] == 'my_project_value'


def test_testaid_varsfiles_extra_vars(host, testvars):
    assert testvars['my_extra_var'] == 'my_extra_value'


def test_testaid_varsfiles_second_file_in_vars_dir(host, testvars):
