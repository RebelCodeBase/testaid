...
def test_testaid__templates_resolve_template_transitive(testvars):
    assert testvars['template3'] == 'my_string_1'


def test_testaid__templates_resolve_template_inline_front(testvars):
    assert testvars['template4'] == 'inline+my_string_1'


def test_testaid__templates_resolve_template_inline_back(testvars):
    assert testvars['template5'] == 'my_string_1+inline'


def test_testaid__templates_resolve_template_special_chars_1(testvars):
