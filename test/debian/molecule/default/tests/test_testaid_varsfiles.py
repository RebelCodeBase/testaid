...
def test_testaid_varsfiles_role_vars(testvars):
    assert testvars['my_role_var'] == 'role_var'


def test_testaid_varsfiles_project_vars(testvars):
    assert testvars['my_project_vars_main'] == 'project_vars_main'


def test_testaid_varsfiles_project_multiple_vars_files(testvars):
    assert testvars['my_project_vars_second'] == 'project_vars_second'


def test_testaid_varsfiles_extra_vars_files(testvars):
