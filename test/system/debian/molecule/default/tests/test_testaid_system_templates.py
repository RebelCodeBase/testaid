...
def test_testaid_system_templates_resolve_template(host,
                                                   testvars):
    assert testvars['my_var_1'] == 'my_string_1'


def test_testaid_system_templates_resolve_template_transitive(host,
                                                              testvars):
    assert testvars['template3'] == 'my_string_1'


def test_testaid_system_templates_resolve_template_inline_front(host,
                                                                testvars):
    assert testvars['template4'] == 'inline+my_string_1'


def test_testaid_system_templates_resolve_template_inline_back(host,
                                                               testvars):
